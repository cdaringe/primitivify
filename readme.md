...
deep copy data, keeping only primitives. complex data in, simple data out. 

useful for serializing complex objects where you only care about the raw data contained within.
